#include <bits/stdc++.h>
/*
 *  Problem Statement: Given 2 integers n and k, find the k-th positive integer not divisible by n.
 *
 *  INPUTS: first line contains integer t (1 <= t <= 10^3)
 *          next t lines contains each test case n and k separated by a space (2 <= n <= 10^9) and (1 <= k <= 10^9)
 *
 *  OUTPUT: for each test case, print the kth positive integer not divisible by n.
 *
 *  Given solution: Each test case: O(1)
 *                  Net time complexity: O(t)
